...
import { CircuitPipelineSVG } from './art/CircuitPipelineSVG';
import {
  Cpu,
  Shield,
  Key,
...
export const ZKPlayground = () => {
  ...
  return (
    <div className="space-y-8" data-testid="zk-playground-view">
      {/* Header */}
      <div className="p-6 sm:p-10 rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-sky-950/40 border border-sky-500/30 space-y-3 shadow-[0_0_40px_rgba(56,189,248,0.1)]">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/30 text-sky-400 text-xs font-mono">
        ...
        <div className="pt-4 flex justify-center">
          <CircuitPipelineSVG className="w-full h-auto max-w-3xl" />
        </div>
      </div>
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 sm:p-8 space-y-5 backdrop-blur-md">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center space-x-2 text-sky-400">
              ...
              <h3 className="font-heading text-base font-bold text-white">Private Witness Inputs (Off-Chain)</h3>
            </div>
          ...
          <div className="space-y-4 font-mono text-xs">
            <div>
              <label className="text-slate-400 block mb-1.5 font-medium">Voter Secret Key (sk):</label>
              <Input
            ...
            <div>
              <label className="text-slate-400 block mb-1.5 font-medium">Target Proposal ID:</label>
              <Input
            ...
            <div>
              <label className="text-slate-400 block mb-1.5 font-medium">Vote Choice (Bounded 0..2):</label>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-xs font-mono font-bold transition-all ${
                      voteChoice === c.val
                        ? 'bg-sky-500/20 border-sky-500 text-sky-300 shadow-[0_0_12px_rgba(56,189,248,0.25)]'
            ...
            <div>
              <label className="text-slate-400 block mb-1.5 font-medium">Blinding Factor (Salt):</label>
              <Input
                data-testid="playground-blinding-salt"
                value={blindingSalt}
                onChange={(e) => setBlindingSalt(e.target.value)}
                className="bg-slate-950 border-slate-800 text-sky-300 font-mono text-xs h-10"
              />
            </div>
          </div>
          ...
          <Button
            ...
            disabled={generating}
            className="w-full bg-gradient-to-r from-sky-500 via-indigo-600 to-purple-600 hover:from-sky-400 hover:to-purple-500 text-white font-mono font-bold text-xs py-3 rounded-xl shadow-[0_0_20px_rgba(56,189,248,0.3)] transition-all"
          >
        ...
        <div className="rounded-3xl border border-slate-800 bg-slate-900/60 p-6 sm:p-8 space-y-5 backdrop-blur-md">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center space-x-2 text-purple-400">
              ...
              <h3 className="font-heading text-base font-bold text-white">Midnight Mathematical Specifications</h3>
            </div>
      ...
      {proofOutput && (
        <div
          ...
          className="rounded-3xl border border-sky-500/40 bg-slate-900/90 p-6 sm:p-8 space-y-5 shadow-[0_0_30px_rgba(56,189,248,0.15)]"
        >
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <div className="flex items-center space-x-2 text-emerald-400">
              <CheckCircle2 className="w-5 h-5" />
              <h3 className="font-heading text-lg font-bold text-white">Generated zk-SNARK Proof Artifact</h3>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-mono text-xs">
            <div className="space-y-2">
              ...
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-sky-400 break-all text-[11px]">
                {proofOutput.public_signals.nullifier}
              </div>
            </div>
            <div className="space-y-2">
              <div className="text-slate-400 text-[11px] uppercase">Ballot Commitment:</div>
              <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 text-purple-300 break-all text-[11px]">
          ...
          <div className="space-y-1.5 font-mono text-xs">
            ...
            <pre className="p-4 rounded-xl bg-slate-950 border border-slate-800 text-slate-300 text-[11px] overflow-x-auto max-h-48 leading-relaxed">
          ...
          <div className="flex items-center space-x-3 pt-2">
            <Button
              ...
              disabled={verifying}
              className="bg-emerald-600 hover:bg-emerald-500 text-white font-mono font-bold text-xs px-6 py-3 rounded-xl shadow-[0_0_20px_rgba(34,197,94,0.3)] transition-all"
            >
          ...
          {verificationResult && (
            <div
              ...
              className={`p-5 rounded-2xl border text-xs font-mono space-y-2.5 ${
